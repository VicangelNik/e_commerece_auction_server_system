...
public class AuctionRepositoryImpl implements AuctionRepository {
  ...
  private static final String INSERT_AUCTION_SQL = "INSERT INTO auctions (title, created, end_date, first_bid, seller_id, category_id) VALUES (?,?,?,?,?,?)";
  ...
  private static final String FIND_ALL_SQL = """
       SELECT
           ac.id, ac.title, ac.created, ac.started, ac.end_date, ac.first_bid, ac.current_best_bid, ac.seller_id, ac.category_id,
